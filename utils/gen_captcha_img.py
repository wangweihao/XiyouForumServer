...
from config import SAVA_CAPTCHA_PATH
...
if platform.system() == "Darwin":
    default_font = "AdobeHeitiStd-Regular.otf"
elif platform.system() == "Linux":
    default_font = "DejaVuSans-Bold.ttf"

# 生成验证码接口
def generate_verify_image(size=(80, 30),
                          chars=init_chars,
                          img_type="GIF",
                          mode="RGB",
    ...
    if save_img:
        name = ''.join([SAVA_CAPTCHA_PATH, img_name, '.gif'])
        img.save(name, img_type)

    return mstream, strs


if __name__ == "__main__":
    mstream, strs = generate_verify_image(save_img=True, img_name='test')
    print strs